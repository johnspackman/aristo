qx.Class.define("aristo.demo.ComboBox", {
  ...
  members: {
    ...
    /**
     * Creates a HTML example. This means that a combobox will be created and
     * filled with some text, that contain HTML tags and entities.
     * 
     * @return {void}
     */
    createHtmlExample: function() {
      ...
      var items = [ "... &gt; (as literal HTML entity)", "... &gt; (as Richtext)", "<b>Bold Text</b>", "<u>Underlined Text</u>",
          "<i>Italic Text</i>", "HTML entities: &laquo; &lt; &amp; &gt; &raquo;" ];
