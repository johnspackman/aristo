qx.Class.define("aristo.demo.TabView", {
	...
	members : {
		_createControls : function() {
			...
			container.add(this.getTabView1(), { row: 0, column: 0 });
			container.add(this.getTabView1().set({ barPosition: "bottom" }), { row: 0, column: 1 });
			container.add(this.getTabView2(), { row: 1, column: 0 });
			container.add(this.getTabView3(), { row: 2, column: 0 });
			container.add(this.getTabView3().set({ barPosition: "right" }), { row: 2, column: 1 });
		},
